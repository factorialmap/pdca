...
O gráfico XmR também conhecido como gráfico de controle de Shewhart é usando quando cada ponto de dados consite em uma obervação de dados contínuos(numericos).
