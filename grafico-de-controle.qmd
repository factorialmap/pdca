...
data_c %>% 
  ...
  stat_QC(method = "c",
          ...
          label.digits = 2)+
  ggthemes::theme_base()+
  labs(title = "Gráfico C de número de defeitos",
       x = "Amostras",
...
data_u %>% 
  ...
  stat_QC(method = "c",
          ...
          label.digits = 3)+
  ggthemes::theme_base()+
  labs(title = "Gráfico U de número de defeitos por unidade")
...
data_np %>% 
  ...
  stat_QC(method = "np",
          ...
          auto.label = TRUE,
          label.digits = 3)+
  labs(title = "Gráfico NP de número de defeitos",
       subtitle = "n = 200",
       y = "# unidades com defeito",
       x = "Unidades")+
  ggthemes::theme_base()
...
p_chart %>% 
  ...
  ggthemes::theme_base()+
  labs(title = "Gráfico P de proporção de itens defeitos",
       x = "Amostras",
