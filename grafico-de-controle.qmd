...
|-----------------|-------------------------------------------------------|
| Contínuo      | Gráfico $x$ ou gráfico de valor individual onde \$\$n =1\$\$                   |
| Contínuo      | Gráfico $\bar{x}$ - $R$ ou gráfico média e amplitude onde \$\$n \> 2 \< 10\$\$ |
| Contínuo      | Gráfico $\bar{x}$ - $S$ ou gráfico média e amplitude com \$\$n \> 10\$\$       |
